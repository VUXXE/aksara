...
const content = [
    {
        ...
        content: (
            <div className="h-full w-full rounded-md flex items-center justify-center text-white bg-gradient-to-br from-purple-500 to-indigo-500">
                <span className="text-2xl font-bold">Website Builder Demo</span>
            </div>
        ),
    },
    {
        ...
        content: (
            <div className="h-full w-full  flex items-center justify-center text-white bg-gradient-to-br from-pink-500 to-rose-500 rounded-md">
                <span className="text-2xl font-bold">Kanban Board Demo</span>
            </div>
        ),
    },
    {
        ...
        content: (
            <div className="h-full w-full rounded-md flex items-center justify-center text-white bg-gradient-to-br from-orange-500 to-yellow-500">
                <span className="text-2xl font-bold">Team Access Demo</span>
            </div>
        ),
    },
    {
        ...
        content: (
            <div className="h-full w-full rounded-md flex items-center justify-center text-white bg-gradient-to-br from-green-500 to-emerald-500">
                <span className="text-2xl font-bold">Leads Dashboard Demo</span>
            </div>
        ),
    },
];
